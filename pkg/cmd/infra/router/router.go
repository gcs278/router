...
type RouterSelection struct {
	...
	UpgradeValidationForceAddCondition    string
	UpgradeValidationForceRemoveCondition string
...
func (o *RouterSelection) Bind(flag *pflag.FlagSet) {
	...
	flag.StringVar(&o.UpgradeValidationForceAddCondition, "upgrade-validation-force-add-condition", env("UPGRADE_VALIDATION_FORCE_ADD_CONDITION", ""), "If set, then the upgrade validation plugin will forcibly add a condition with the type of the value specified.")
	flag.StringVar(&o.UpgradeValidationForceRemoveCondition, "upgrade-validation-force-remove-condition", env("UPGRADE_VALIDATION_FORCE_REMOVE_CONDITION", ""), "If set, then the upgrade validation plugin will forcibly remove a condition with the type of the value specified.")
